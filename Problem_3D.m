...
for iter = 1:numberOfIterations
    ...
    u11 = u11 - gamma * (J_10 * F11_1 + J_101 * F11_2);
    u12 = u12 - gamma * (J_10 * F12_1 + J_102 * F12_2);
    u13 = u13 - gamma * (J_10 * F13_1 + J_103 * F13_2);
    u14 = u14 - gamma * (J_10 * F14_1 + J_104 * F14_2);
    u15 = u15 - gamma * (J_10 * F15_1 + J_105 * F15_2);
    u16 = u16 - gamma * (J_10 * F16_1 + J_106 * F16_2);
    
    u21 = u21 - gamma * (J_20 * F21_1 + J_201 * F21_2);
    u22 = u22 - gamma * (J_20 * F22_1 + J_202 * F22_2);
    u23 = u23 - gamma * (J_20 * F23_1 + J_203 * F23_2);
    u24 = u24 - gamma * (J_20 * F24_1 + J_204 * F24_2);
