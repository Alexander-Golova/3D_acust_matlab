...
% координаты приемников завис€т от источника
% номер источника
number_Sourse = 1;
X_Res = zeros(N^3, 1);
Y_Res = zeros(N^3, 1);
...
% визуализаци€ источников и приЄмников
...
% вычисл€ем матрицу over_a дл€ каждого источника
a_11 = zeros(N^3);
a_12 = zeros(N^3);
a_13 = zeros(N^3);
a_14 = zeros(N^3);
...
% дл€ правой части основной системы
f_1_R_1 = zeros(N^3, 1);
f_1_R_2 = zeros(N^3, 1);
f_1_R_3 = zeros(N^3, 1);
f_1_R_4 = zeros(N^3, 1);
